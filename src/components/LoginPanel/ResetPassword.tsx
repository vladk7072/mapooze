...
import { IResetPasswordErrors, ResetPasswordType } from "../../types/LoginPanelTypes";
import { validationSchemaResetPassword } from "./loginpanel.data";

export const ResetPassword: FC<ResetPasswordType> = ({ isOpenAside }) => {
  const navigate = useNavigate();
  const [isVisibleMismatch, setVisibleMismatch] = useState(false);

  const [isHiddenPassword, setHiddenPassword] = useState(true);
  const [isHiddenRePassword, setHiddenRePassword] = useState(true);
  ...
  const hiddenRePasswordHandler = () => {
    if (isHiddenRePassword) {
      setHiddenRePassword(false);
    } else {
      setHiddenRePassword(true);
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className="loginpanel">
        ...
        <Formik
          initialValues={{ newpassword: "", repassword: "", mismatch: "" }}
          validationSchema={validationSchemaResetPassword}
          validate={(values) => {
            const errors = {} as IResetPasswordErrors;
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="main-input__item main-input__item-pt5">
                <input
                  ...
                  type={isHiddenRePassword ? "password" : "text"}
                  className={
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  className="main-input__view-password"
                  onClick={() => hiddenRePasswordHandler()}
                >
                  <path
                    d="M4.28065 11.8199C2.79398 10.8466 1.83398 9.3799 1.83398 8.09323C1.83398 5.90656 4.59398 3.22656 8.00065 3.22656C9.39398 3.22656 10.6873 3.67323 11.7273 4.36656"
                    stroke="#29ABE2"
