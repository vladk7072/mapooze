...
import { ILoginPanelErrors, LoginPanelType } from "../../types/LoginPanelTypes";
import { validationSchemaLoginPanel } from "./loginpanel.data";
import { SocialsBottom } from "./components/SocialsBottom";

export const LoginPanel:FC<LoginPanelType> = ({ isOpenAside }) => {
    ...
    >
      ...
      <div className="loginpanel">
        <div className="loginpanel__top">
          ...
          <span>I</span>
          <Link className="loginpanel__top-item" to="../register">
            Register
          </Link>
        </div>
        <div className="loginpanel__pretext">
          Enter your username and <br /> password to login
        </div>
        <Formik
          initialValues={{ email: "", password: "" }}
          validationSchema={validationSchemaLoginPanel}
          validate={(values) => {
            const errors = {} as ILoginPanelErrors;
            if (!values.email) {
        ...
        >
          {({
            ...
            <form onSubmit={handleSubmit}>
              ...
              <NavLink className="loginpanel__forgot" to="../forgot">
                Forgot Password?
              </NavLink>
              <button
        ...
        <SocialsBottom title={"Or login with"} />
      </div>
    </div>
  );
};
