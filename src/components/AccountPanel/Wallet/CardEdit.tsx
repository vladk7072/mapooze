...
import { ICardEditErrors } from "../../../types/AccountPanel/AccountWalletTypes/AddWalletTypes";
...
export const CardEdit: FC = () => {
  ...
  return (
    <div className="addwallet">
      <Link className="addwallet__prev" to="../wallet/1">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div className="addwallet__error-title addwallet__error-title--mt20">
        Please edit your Wallet “Cryptocurrency 1” and click Save
      </div>
      <div className="addwallet__new-title">Edit Wallet “Cryptocurrency 1”</div>
      <div className="addwallet__form">
        <Formik
          initialValues={{
            name: "Cryptocurrency 2",
            walletaddress: "rdwN ETj3 hQEx1KGe NiDw zH5N",
            email: "jack.brown@gmail.com",
            password: "testpasswordD2023",
          }}
          validate={(values) => {
            const errors = {} as ICardEditErrors;
            if (!values.name) {
