...
import { myBidsData } from "./mybids.data";
import { MyBidsItem } from "./MyBidsItem";

interface IProps {
  setOpenBar: (args: boolean) => void;
}
export const MyBids: FC<IProps> = ({ setOpenBar }) => {
  ...
  return (
    <div className="analytics">
      ...
      <div className="addwallet__error-title addwallet__error-title--active">
        Here you can find information about your participation in auctions
      ...
      <div className="auction">
        <div className="auction__items">
          {myBidsData.map((el, idx) => (
            <MyBidsItem {...el} key={idx} />
          ))}
        </div>
      </div>
    </div>
