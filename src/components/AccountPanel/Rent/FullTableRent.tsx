...
export const FullTableRent: FC<any> = ({ setOpenBar }) => {
  const { isMobile } = useAppSelector((state) => state.mainPanelReducer);

  return (
    <div className="addwallet">
      {isMobile ? (
        <Link onClick={() => setOpenBar(false)} to="../rent">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <div className="addwallet__mob-title">Full table for Rent</div>
      ...
      <div className="wishlist fullitem rent">
        <div className="salepanel__safe">
          <div className="salepanel__top">
            ...
            <div className="salepanel__box fullitem__box-bor">
              <div className="salepanel__top-title">% Rate</div>
            </div>
            <div className="salepanel__box fullitem__box-bor">
              <div className="salepanel__top-title">Rent Period</div>
            </div>
            <div className="salepanel__box fullitem__box-bor ">
              <div className="salepanel__top-title">Total Amount</div>
            </div>
            <div className="salepanel__box fullitem__box-bor ">
