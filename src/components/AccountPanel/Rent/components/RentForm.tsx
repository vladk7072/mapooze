...
import { IRentErrors } from "../../../../types/AccountPanel/RentTypes/RentTypes";
    ...
    <div className="saleplace__general saleplace__general--pt28">
      ...
      >
        {({
          ...
          <form className="rent__form" onSubmit={handleSubmit}>
            ...
            <div className="saleplace__general-trials rent__mt28">
              <div className="form-item">
                <InputMask
                  mask="99/99/99"
                  name=""
            ...
            <div className="rent__bottom rent__mt28">
              <div className="form-item">
                <input
                  name="total"
                  id="total"
                  ...
                  placeholder="Ваш номер телефона"
                />
                <label htmlFor="landprice" style={{ fontSize: 10 }}>
                  Total Amount
                </label>
                <svg
                  className="saleplace__svg"
              ...
              <div className="main-input__checkbox rent__checkbox">
                <label
                ...
                >
                  ...
                  <div className="main-input__check-title">
                    I agree to <br />
                    <Link to="../../policy">rent rules</Link>
                  </div>
                </label>
