...
//@ts-ignore
import img4 from "../../../assets/images/saleplace/4.jpg";
import { RentType } from "../../../types/AccountPanel/RentTypes/RentTypes";
import { useAppSelector } from "../../../hooks/redux-hooks";
import { TextForLands } from "../../../globalComponents/TextForLands";
import { TEXT_CONTENT, slidesPhoto } from "./rent.data";
...
export const Rent: FC<RentType> = ({ setOpenBar }) => {
  ...
  return (
    <div className="exchange saleplace addwallet">
      ...
      <div className="addwallet__mob-title">Lands for Rent</div>
      <div className="addwallet__error-title addwallet__error-title--active">
        You can select the land for rent
