...
import { AnalyticsType } from "../../../types/AccountPanel/AnalyticsTypes/AnalyticsTypes";
import { Age } from "./components/Age";
import { ProfileView } from "./components/ProfileView";
import { Gender } from "./components/Gender";
import { CountryActivity } from "./components/CountryActivity";
import { LandBlock } from "./components/LandBlock";

export const Analytics: FC<AnalyticsType> = ({ setOpenBar }) => {
  ...
  return (
    <div className="analytics">
      ...
      <div className="addwallet__error-title addwallet__error-title--active">
        You can select analyze the data
      ...
      <div className="analytics__wrapper">
        ...
        <div className="analytics__med">
          <Gender />
          <div>
            <LandBlock title="Purchased Land " />
            <LandBlock title="Sold Land " />
          </div>
          <CountryActivity />
        </div>
      </div>
